...
{
ShowMessage(L"Удерживая левую кнопку мыши можно двигать проекцию, тем самым положение точек. PointParameters меняет точечные параметры. Animate создает анимацию проекции.");
}
//---------------------------------------------------------------------------
